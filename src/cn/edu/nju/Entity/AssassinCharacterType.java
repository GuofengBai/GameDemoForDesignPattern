...
public class AssassinCharacterType implements CharacterType {

    private Character owner;

    public AssassinCharacterType(Character owner) {
        this.owner = owner;
    }
    ...
    public Integer levelUp() {
        ...
        if(cost<owner.getExperience()){
            ...
            baseAttr.setAp(baseAttr.getAp()*1.047619047619048);
        }
